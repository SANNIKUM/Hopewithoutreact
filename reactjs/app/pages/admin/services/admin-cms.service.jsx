 ...
 */
  ...
  getUsers: function (siteId,qcinstances) {
    ...
    let variables = `{
                        ...
                        "types": [{"name": "team", "properties": []},{"name": "user", "properties": ["email","firstName","lastName","canvasserType"]},{"name": "countInstanceStatus", "properties": []}]
                      }`;
    let specs ={
      user:{
        team:null,
  ...
  getBoroughsAndSites: function (qcinstances) {
    ...
    let variables = `{
                        ...
                        "types": [{"name": "zone","properties": []},{"name": "site","properties": []},{"name": "team", "properties": ["location"]}]
                      }`;
    let specs = {
                       zone: {
                            site:{
 ...
 */
  getTeamsForSelectedSite: function (selectedSite,qcinstances) {
    const contextAssignmentIds = qcinstances.concat([selectedSite.siteId]).join(",")
    let variables = `{
                        "contextAssignmentIds": [${contextAssignmentIds}],
                        "types": [{"name": "site", "properties": []},{"name": "team", "properties": []},{"name": "user", "properties": ["email","firstName","lastName","isTeamLeader"]},{"name": "route", "properties": ["type","station","needs_nypd","park"]},{"name": "countInstanceStatus", "properties": []}]
                      }`;
    let specs = {
                                site:{
                                   team:{
  ...
  getRoutesBySite: function (siteId,qcinstances) {
    ...
    let variables = `{
                        "contextAssignmentIds": [${contextAssignmentIds}],
                        "types": [{"name": "team", "properties": []},{"name": "route", "properties": ["type","station","needs_nypd","park"]},{"name": "countInstanceStatus", "properties": []}]
                      }`;
     let specs = {
                                    route:{
                                        team:null,
