  ...
  */
  componentWillMount() {
    if (this.props.data == null || (Object.keys(this.props.data).length == 0)) {
      this.props.model.selectedTeamForConvesser = null;
    }
    else if (this.props.data.team) {
      this.props.data.team.length > 0 ? this.props.model.selectedTeamForConvesser = { id: this.props.data.team[0].id, label: this.props.data.team[0].label } : this.props.model.selectedTeamForConvesser = null;
    }
  }
 ...
 */
  ...
  OnConvesserTypeChanged(type) {
    this.props.dispatch(Action.getAction(adminActionTypes.SET_CONVESSER_TYPE, { value: type }));
  }
  /**
  ...
  OnTeamChanged(team) {
    this.props.dispatch(Action.getAction(adminActionTypes.SET_SELECTED_TEAM_FOR_CONVESSER, { value: team }));
  }
 ...
 */
  onAddUpdateCanvassser(e) {
    ...
    this.props.data != null && (Object.keys(this.props.data).length > 0) && this.props.data.name !== ''
      ? action = Constants.action.update
      : action = Constants.action.add;
    if (e.keyCode === 13) {
      if (this.validateModal()) {
        this.props.onAddUpdateDeleteCanvasser({
          action: action, id: ((this.props.data && this.props.data != null) ? this.props.data.id : -1),
          firstName: this.firstName.value.trim(), lastName: this.lastName.value.trim(), email: this.email.value.trim(),
          oldCanvasser:this.props.model.rightSideModel.editCanvasser,
              ...
              <tr className="profile-first-row">
                <td className="first-column">
                  ...
                  <input
                    ...
                    defaultValue={this.props.data && this.props.data.properties != null ? this.props.data.properties.firstName : ''}
                ...
                <td className="sec-column">
                  ...
                  <input
                    ...
                    defaultValue={this.props.data && this.props.data.properties != null ? this.props.data.properties.lastName : ''}
                    onKeyUp={(e) => this.onAddUpdateCanvassser(e)}
                  />
                </td>
              </tr>
              ...
              <tr className="profile-first-row">
                <td className="first-column">
                  ...
                  <input
                    type="text"
                    className="text-control"
                    ref={(input) => (this.email = input)} disabled={this.props.data ? (this.props.data.email ? "disabled" : "") : ""}
                    defaultValue={this.props.data && this.props.data.properties != null ? Utility.getCanvasserDetails(this.props.data).email : ''}
                    onKeyUp={(e) => this.onAddUpdateCanvassser(e)}
                  />
                </td>
                <td className="sec-column">
...
const mapStateToProps = (state) => {
  return { model: state.adminModel }
}

export default connect(mapStateToProps)(CreateCanvasserModal);
